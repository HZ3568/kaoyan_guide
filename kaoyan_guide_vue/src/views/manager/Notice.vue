<template>
  <div>
    <div class="card" style="margin-bottom: 5px">
      <el-input v-model="data.title" style="width: 240px; margin-right: 10px" placeholder="请输入公告标题查询"></el-input>
    ...
    <div class="card" style="margin-bottom: 5px">
      <el-table stripe :data="data.tableData" tooltip-effect="dark myTooltip" @selection-change="handleSelectionChange">
