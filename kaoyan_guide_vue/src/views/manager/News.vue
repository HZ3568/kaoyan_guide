<template>
  <div>
    <div class="card" style="margin-bottom: 5px;">
      <el-input v-model="data.name" placeholder="请输入资讯标题查询" style="width: 240px"></el-input>
    ...
    <div class="card" style="margin-bottom: 5px;">
      <el-table :data="data.tableData" tooltip-effect="dark myTooltip" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="intro" label="资讯简介" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="高考资讯" v-model="data.formVisible" width="50%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="data.form" :rules="data.rules" label-width="80px"  style="padding: 20px 30px" ref="formRef">
        <el-form-item label="资讯标题" prop="name">
          <el-input v-model="data.form.name" placeholder="资讯标题"></el-input>
        </el-form-item>
        ...
        <el-form-item label="资讯简介" prop="intro">
          <el-input v-model="data.form.intro" placeholder="资讯简介" type="textarea" rows="4"></el-input>
        </el-form-item>
